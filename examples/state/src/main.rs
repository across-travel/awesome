...
//!
//! For global shared state, we wrap our state in a `kayrx::web::web::Data` and move it into
...
//!
//! By default, `kayrx::web` runs one `App` per logical cpu core.
...
//! equally among cores.
//!
//! Check [user guide](https://kayrx.xyz/kayrx/app/#state) for more info.
